...
public class TestArvore
{
    ...
    public void testInserir() throws LoginIndisponivelException
    {
        ...
        Usuario user2 = new UsuarioVip("Eloiza", "elo", "123");
        Usuario user3 = new UsuarioVip("Miguel", "migs", "123");
        ...
        assertEquals(user, arvore.getRaiz().getInfo());
        assertEquals(user1, arvore.getRaiz().getDireita().getInfo());
    }

    @Test
    public void testBuscar() throws LoginIndisponivelException, UsuarioNaoExisteException
    {
        Abb arvore = new Abb();
        Usuario user = new UsuarioAdm();
        Usuario user1 = new UsuarioVip("Will", "will", "123");
    ...
    public void testRemover() throws LoginIndisponivelException, UsuarioNaoExisteException
    {
        ...
        Usuario user2 = new UsuarioVip("Eloiza", "elo", "123");
        Usuario user3 = new UsuarioVip("Miguel", "migs", "123");
        Usuario user4 = new UsuarioVip("Nadine", "nadis", "123");
        Usuario user5 = new UsuarioVip("Zeus", "zeus", "123");
